# Generated by Django 3.2.14 on 2022-10-11 09:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_update', models.DateTimeField(auto_now=True, verbose_name='Время изменения')),
                ('is_published', models.BooleanField(default=True, verbose_name='Публикация')),
                ('balcony', models.ForeignKey(default=2, on_delete=django.db.models.deletion.PROTECT, to='agency.balcony', verbose_name='балкон')),
                ...
                ('object_type', models.ForeignKey(help_text='выберете тип объекта', on_delete=django.db.models.deletion.PROTECT, to='agency.incityobjecttype', verbose_name='тип объекта')),
